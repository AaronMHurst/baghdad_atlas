...
SELECT nucleus.energy_gamma AS " E [keV] ", nucleus.d_energy_gamma 
       ...
       * sqrt(square(nucleus.d_intensity_gamma/nucleus.intensity_gamma) 
       ...
       WHERE sample.A = 162 AND sample.Z = 66
       AND nucleus.nuc_Z = sample.Z
       AND nucleus.sample = 'E'
       AND nucleus.nuc_symb = '162Dy';

SELECT COUNT(energy_gamma) AS "No. enriched 162Dy gammas:" 
       FROM nucleus
       WHERE nucleus.sample = 'E' AND nucleus.nuc_symb = '162Dy';
