...
2017-09-07: print_elem function edited by Aaron Hurst <amhurst@berkeley.edu>: 
The int64_t variable 'c' is cast to a (long long) type to fix format-specifier 
warning about argument type.
...
void print_elem(void *e, int64_t c, void* p){
  int ee = *(int*)(e);
  /*printf("%d => %lld\n", ee,c);*/
  /*To fix format-specifier warning use the following cast*/
  printf("%d => %lld\n", ee,(long long)(c));
}
